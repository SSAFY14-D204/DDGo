...
def _extract_joint_pose_targets_from_mapped(
    ...
    def arm_angles(
        ...
        upper_x, _, _ = frame_from_segments(elbow - shoulder, hand_tip - elbow, up)
        ...
        elbow_flex = math.pi - angle_3d(shoulder, elbow, hand_tip)
    ...
    s1_r, s2_r, e_r = arm_angles(rs, re, rw, rhand_tip, side_sign=1.0)
    s1_l, s2_l, e_l = arm_angles(ls, le, lw, lhand_tip, side_sign=-1.0)
    ...
    larm_x, larm_y, larm_z = frame_from_segments(le - ls, lhand_tip - le, up)
    rarm_x, rarm_y, rarm_z = frame_from_segments(re - rs, rhand_tip - re, up)
...
"""
    ...
    equality_block = """
  <equality>
    <weld name="weld_hand_right" body1="hand_right" body2="mocap_wrist_right" active="false" solref="0.02 1" solimp="0.9 0.95 0.01"/>
    <weld name="weld_hand_left" body1="hand_left" body2="mocap_wrist_left" active="false" solref="0.02 1" solimp="0.9 0.95 0.01"/>
    <weld name="weld_foot_right" body1="foot_right" body2="mocap_ankle_right" active="false" solref="0.02 1" solimp="0.9 0.95 0.01"/>
    <weld name="weld_foot_left" body1="foot_left" body2="mocap_ankle_left" active="false" solref="0.02 1" solimp="0.9 0.95 0.01"/>
  </equality>
"""
...
def apply_pose_to_model(
    ...
    return {
        "left_wrist": mapped_points.get("left_hand_tip", mapped_points["left_wrist"]),
        "right_wrist": mapped_points.get("right_hand_tip", mapped_points["right_wrist"]),
        "left_ankle": mapped_points.get("left_toe", mapped_points["left_ankle"]),
        "right_ankle": mapped_points.get("right_toe", mapped_points["right_ankle"]),
    }
