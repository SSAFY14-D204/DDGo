...
public class UserController {
    ...
    @Operation(summary = "회원가입", description = "아이디(이메일 형식), 비밀번호, 닉네임으로 새 계정을 생성합니다.")
    ...
    @Operation(summary = "로그인", description = "아이디(이메일 형식)와 비밀번호로 로그인하여 Access Token과 Refresh Token을 발급받습니다.")
    @PostMapping("/login")
