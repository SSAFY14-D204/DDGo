...
internal fun buildChallengeFinalAnalysisSummary(
    ...
    val attempts = validAttemptSummaries.map { summary ->
        ChallengeAttemptComparisonItem(
            ...
            stabilityRetentionScore = summary.stabilityRetentionScore ?: summary.insideSupportRatio,
            stabilityRecoveryScore = summary.stabilityRecoveryScore,
            lowerBodyDriveScore = summary.lowerBodyDriveScore,
