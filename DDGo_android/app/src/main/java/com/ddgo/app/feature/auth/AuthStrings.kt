...
internal object AuthStrings {
    ...
    const val WelcomeIntroTitle =
        "반가워요,\n디디고와 함께 기록하면\n클라이밍이 쉬워져요"
    const val WelcomeFeatureAnalysis = "클라이밍 영상을\n데이터로 분석해요"
    const val WelcomeFeatureRealtime = "실시간으로 등반을 촬영하고\n맞춤 피드백 받아요"
    const val WelcomeFeatureVideo = "과거 등반 영상도\n맞춤 분석 받을 수 있어요"
    const val WelcomeFeatureGrowth = "쌓이는 기록과 분석을 통해\n성장하는 실력을 확인해요"
